...
<h1 style="margin-bottom: 50px;">Spencer Shreiner's Profile </h1>
...
<div style="margin-left: 400px;">
        <h2>Spencer's Info</h2>
            ...
            <p>Nature: Spencer is timid and afraid of both dogs and other cats.</p>
            <p>Microchipped: Yes</p>
            <p> WARNING: She is very scared of other animals. </p>
        </div>
